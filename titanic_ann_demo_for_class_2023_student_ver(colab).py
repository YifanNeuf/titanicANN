...
Original file is located at
    https://colab.research.google.com/drive/1MDQyIN9v0YJj7ruYKnTIlx04R7lW28Hq
"""
...
# 6.3.1 Add third hidden layer
model.add(Dense(units=96, activation='relu'))

# 6.3.2 Add forth hidden layer
...
opt=SGD(learning_rate=0.1,momentum=0.9) # 這裡改參數
...
# Important
x_training,x_validation,y_training,y_validation=train_test_split(x_train,y_train,test_size=0.2,random_state=10) # random_state=44 是重複測試要調整的地方
